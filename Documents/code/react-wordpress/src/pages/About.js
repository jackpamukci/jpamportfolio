        ...
        <div className="App-header">
          ...
          <div className='aboutMe'>
            ...
            <div className="aboutVis">
              <img className='aboutImage' loading='lazy' src={about}/>
            </div>
          ...
          <div>
            ...
            <div class='mx-auto mt-10 w-75 border-b-2 border-black'/>
              ...
              <div class="something">
                <div class="aboutWho">
                  <img class="inline h-3" src={github}/>
                  <a class="aboutLinks" target="blank" href="https://github.com/jackpamukci">jackpamukci</a>
                </div>
                <div class="aboutWho">
                  <img class="inline h-3" src={email}/>
                  <a class="aboutLinks" target="blank" href="">jackpamukci824@gmail.com</a>
                </div>
                <div class="aboutWho">
                  <img class="inline h-3" src={linkedin}/>
                  <a class="aboutLinks" target="blank" href="https://www.linkedin.com/in/jackpamukci/">jpamukci</a>
                </div>
                <div class="aboutWho">
                  <img class="inline h-3" src="https://uploads-ssl.webflow.com/62ae10f6bb3c552ac1412e5d/62b4b78803e60a8f4a48f3f6_Twitter%20Logo%20-%20Black.png"/>
